...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		<td class="row1" colspan="2" align="center"><span class="gensmall">{L_CONFIRM_CODE_IMPAIRED}</span><br /><br />{MESSAGE_KEY} : {KEY}<br /><br /></td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_CONFIRM_CODE}: * </span></td>
	  <td class="row2"><input type="text" class="post" style="width: 200px" name="confirm_code" size="8"  value="" /></td>
	</tr>
	<!-- END switch_confirm -->
	<tr> 
	...
	<tr> 
	  <td class="row1"><span class="gen">{L_NOTIFY_ON_NEW_TOPIC}</span></td>
	  <td class="row2"> 
		<input type="radio" name="notifynewtopic" value="1" {NOTIFY_NEW_TOPIC_REPLY_YES} />
		<span class="gen">{L_YES}</span>&nbsp;&nbsp; 
		<input type="radio" name="notifynewtopic" value="0" {NOTIFY_NEW_TOPIC_REPLY_NO} />
		<span class="gen">{L_NO}</span></td>
	</tr>
	<tr> 
