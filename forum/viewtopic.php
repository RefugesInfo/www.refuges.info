...
$sql = "SELECT t.topic_id, t.topic_title, t.topic_status, t.topic_replies, t.topic_time, t.topic_type, t.topic_vote, t.topic_last_post_id,t.topic_id_point, f.forum_name, f.forum_status, f.forum_id, f.auth_view, f.auth_read, f.auth_post, f.auth_reply, f.auth_edit, f.auth_delete, f.auth_sticky, f.auth_announce, f.auth_pollcreate, f.auth_vote, f.auth_attachments" . $count_sql . "
...
$pagination = ( $highlight != '' ) ? generate_pagination("viewtopic.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;postdays=$post_days&amp;postorder=$post_order&amp;highlight=$highlight", $total_replies, $board_config['posts_per_page'], $start) : generate_pagination("viewtopic.$phpEx?" . POST_TOPIC_URL . "=$topic_id&amp;postdays=$post_days&amp;postorder=$post_order", $total_replies, $board_config['posts_per_page'], $start);
	...
	/**** Ajout par sly pour lien de retour vers la fiche point concernée 23/01/2011****/
	// uniquement sur le "forum des refuges" a cote du titre du forum, lien pour retourner a la fiche
...
$template->assign_vars(array(
    ...
    'TOPIC_ID' => $topic_id,
    'TOPIC_TITLE' => $topic_title.$lien_retour_fiche,
...
for($i = 0; $i < $total_posts; $i++)
{
	...
	/**** Ajout par sly pour lien de retour vers la fiche point concernée 23/04/2007****/
	// uniquement sur le "forum des refuges" et uniquement le premier post mais pas le message de présentation

	if ( $forum_id == 4 AND $_GET['t']!=537 and $message=="")
	{
		$message.="	<p>Laisser ses impressions, des appréciations et discuter de choses diverses autour de ".$forum_topic_data['topic_title']."
				Les commentaires (sur la fiche) sont dédiés à une information objective. </p>
				";
	}
