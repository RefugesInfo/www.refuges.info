...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> 'À quoi sert « Supprimer les cookies du forum » ?',
	...
	'HELP_FAQ_PMS_SPAM_ANSWER'		=> 'Le formulaire de courrier électronique du forum comprend des sécurités pour suivre les utilisateurs qui envoient de tels messages. Envoyez à l’administrateur une copie complète de l’e-mail reçu. Il est très important d’inclure les en-têtes (ils contiennent des informations sur l’expéditeur de l’e-mail). L’administrateur pourra alors prendre les mesures nécessaires.',
	'HELP_FAQ_PMS_SPAM_QUESTION'	=> 'J’ai reçu un spam ou un e-mail abusif d’un membre de ce forum !',
	...
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_ANSWER'		=> 'Seuls les membres peuvent s’envoyer des e-mails via le formulaire intégré (si la fonction a été activée par l’administrateur). Ceci pour empêcher l’utilisation malveillante de la fonctionnalité par les invités.',
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_QUESTION'	=> 'Lorsque je clique sur le lien <em>e-mail</em> d’un membre, on me demande de me connecter !?',
