...
$lang = array_merge($lang, array(
	...
	'ACP_SHORT'						=> 'PCA',
	'ACTIVATION_ALREADY_SENT'		=> 'Le courriel d’activation vous a déjà été envoyé. Vous pouvez réessayer dans 24 heures. Si le problème persiste, contactez l’administrateur du forum.',
	'ACTIVE'						=> 'Actif',
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> 'Ce service est déjà associé à un autre compte du forum.',
	...
	'AVATAR_NO_UPLOAD_DIR'			=> 'Le répertoire de stockage des avatars n’existe pas ou n’est pas accessible en écriture.',
	...
	'FILESYSTEM_CANNOT_CREATE_DIRECTORY'		=> 'Impossible de créer un répertoire',
	'FILESYSTEM_CANNOT_DELETE_FILES'			=> 'Impossible de supprimer les fichiers du système',
	'FILESYSTEM_CANNOT_DUMP_FILE'				=> 'Impossible de sauvegarder dans un fichier',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'		=> 'Impossible de mettre en miroir le répertoire',
	'FILESYSTEM_CANNOT_RENAME_FILE'				=> 'Impossible de renommer un fichier du système',
	'FILESYSTEM_CANNOT_TOUCH_FILES'				=> 'Impossible de créer un fichier ou de modifier son horodatage',
	...
	'LOGIN_ERROR_ATTEMPTS'				=> 'Vous avez dépassé le nombre maximum autorisé de tentatives de connexion. En plus de votre nom d’utilisateur et de votre mot de passe, vous devez également valider le test CAPTCHA.',
	...
	'NOTIFICATION_REPORT_PM_CLOSED'		=> '<strong>Rapport de message privé fermé</strong> par %1$s :',
	...
	'NO_STYLE_DATA'				=> 'Impossible de récupérer les données de style concernant les éléments suivants : user_style = %s et user_id = %s',
	'NO_STYLE_CFG'				=> 'Impossible de récupérer les données du fichier de configuration pour le style : %s',
	...
	'POST_UNAPPROVED_EXPLAIN'	=> 'Ce message n’est pas visible pour les autres utilisateurs tant qu’il n’est pas approuvé par un modérateur.',
