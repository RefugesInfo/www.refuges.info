...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'IPPORT'		=> 'Adresse IPv4 ou IPv6 valide avec un numéro de port.',
		'IPV4'			=> 'Adresse IPv4 valide.',
		'IPV6'			=> 'Adresse IPv6 valide.',
		'MAP'			=> 'Associe des chaînes à leur valeur de remplacement sous la forme <samp>{MAP=string1:replacement1,string2:replacement2}</samp>. Insensible à la casse. Par défaut, préserve les valeurs inconnues.',
		'RANGE'			=> 'Accepte un entier dans la plage donnée, par exemple <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Valide sa valeur contre une expression régulière donnée, par exemple <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'Horodatage tel que <samp>1h30m10s</samp>, qui sera converti en nombre de secondes. Accepte également un nombre.',
		'UINT'			=> 'Entier positif. Identique à <samp>{INT}</samp>, mais rejette les valeurs inférieures à 0.',
	),
));
