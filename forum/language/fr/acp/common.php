...
$lang = array_merge($lang, array(
	...
	'ACP_STYLES_INSTALL'		=> 'Installer les styles',
	...
	'REMIND'				=> 'Rappeler',
	'REPARSE_LOCK_ERROR'	=> 'Une ré-analyse est déjà en cours par un autre processus.',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_FUNC_OVERLOAD'					=> 'La fonction de surchage n’est pas configurée correctement.',
	...
	'VALUE'						=> 'Valeur',
	'VERSIONCHECK_FAIL'			=> 'Échec pour obtenir l’information de la dernière version.',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN'		=> 'Ceci est la liste des membres récemment enregistrés, mais encore inactifs. Vous pouvez activer, supprimer ou contacter (en envoyant un e-mail) ces membres si vous le souhaitez.',
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Ceci est la liste des 10 derniers comptes créés restés inactifs. Ces comptes sont inactifs soit parce que l’activation de compte est/était activée dans les paramètres des enregistrements et que ces comptes d’utilisateurs n’ont pas encore été activés, soit parce que ces comptes ont été désactivés. Une liste complète des membres inactifs est disponible en cliquant directement sur le lien ci-dessous. Vous pourrez activer, supprimer ou contacter (par l’envoi d’e-mail) ces membres si vous le souhaitez.',
...
$lang = array_merge($lang, array(
	...
	'LOG_BAN_EXCLUDE_EMAIL'	=> '<strong>Débannissement d’e-mail</strong> pour la raison suivante : « <em>%1$s</em> »<br />» %2$s',
	...
	'LOG_BAN_EMAIL'			=> '<strong>Bannissement d’un e-mail</strong> pour la raison suivante : « <em>%1$s</em> »<br />» %2$s',
	...
	'LOG_INACTIVE_REMIND'	=> '<strong>Envoi d’un rappel par e-mail aux membres inactifs</strong><br />» %s',
	...
	'LOG_MASS_EMAIL'		=> '<strong>Envoi de l’e-mail de masse</strong><br />» %s',
	...
	'LOG_USER_UPDATE_EMAIL'	=> '<strong>Modification de l’e-mail du membre « %1$s » </strong><br />» de « %2$s » à « %3$s »',
