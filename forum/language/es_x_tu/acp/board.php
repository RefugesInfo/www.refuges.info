...
//	'ACC_USER_ADMIN'			=> 'Usuario + Admin',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'Número mínimo de caracteres en las contraseñas. Ten en cuenta que el número máximo no está limitado.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'	=> 'Habilita la autenticación HTTP, lo que permite a los usuarios acceder a contenidos ocultos para los visitantes añadiendo el parámetro <samp>auth=http</samp> a la URL del feed. Ten en cuenta que algunas configuraciones de PHP pueden requerir cambios adicionales en el archivo .htaccess; consulta dicho archivo para obtener más información. La autenticación HTTP solo es compatible con conexiones cifradas (https).',
...
$lang = array_merge($lang, array(
	...
	'APACHE_SETUP_BEFORE_USE'	=> 'Debes configurar la autenticación de Apache antes de cambiar phpBB a este método de autenticación. Ten en cuenta que el nombre de usuario que usa para la autenticación de apache debe ser el mismo que tu nombre de usuario phpBB. La autenticación de Apache solo se puede usar con mod_php (no con una versión CGI).',
