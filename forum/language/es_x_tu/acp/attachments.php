...
$lang = array_merge($lang, array(
	...
	'IMAGE_QUALITY_EXPLAIN'		=> 'Especifica un valor entre 50% (tamaño de archivo más pequeño) y 90% (mayor calidad). Una calidad superior al 90% aumenta el tamaño del archivo y está deshabilitada. La configuración solo se aplica si las dimensiones máximas de la imagen se establecen en un valor distinto de 0px por 0px.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'			=> 'Dimensiones máximas de las imágenes adjuntas. phpBB puede intentar ajustar automáticamente el tamaño de las imágenes antes de subirlas para que se ajusten a estas dimensiones máximas. Establece ambos valores en 0 píxeles por 0 píxeles para desactivar la comprobación de dimensiones y el ajuste automático del tamaño.',
