...
$lang = array_merge($lang, array(
	...
	'ACP_SHORT'						=> 'PCA',
	'ACTIVATION_ALREADY_SENT'		=> 'El correo electrónico de activación ya ha sido enviado a tu dirección de correo electrónico. Puedes volver a intentarlo después de 24 horas. Si continúas teniendo problemas para activar tu cuenta, contacta con un Administrador del foro.',
	'ACTIVE'						=> 'Activo',
	...
	'BOARD_BAN_PERM'		=> 'Has sido expulsado <strong>permanentemente</strong> de este sitio.<br /><br />Por favor, contacta con la %2$sAdministración del sitio%3$s para más información.',
	'BOARD_BAN_REASON'		=> 'Motivo de la exclusión: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Has sido excluido de este sitio hasta <strong>%1$s</strong>.<br /><br />Por favor, contacta con la %2$sAdministración del sitio%3$s para más información.',
	...
	'CONFIRM_CODE_WRONG'	=> 'El código de confirmación que has introducido es incorrecto.',
	...
	'JABBER'	=> 'Jabber',
	'JOINED'	=> 'Registrado',
	'JUMP_PAGE'	=> 'Introduce el número de página donde quieres ir',
	'JUMP_TO'	=> 'Ir a',
	...
	'LOGIN_CONFIRM_EXPLAIN'	=> 'Para prevenir el forzado de cuentas, la Administración del sitio requiere que introduzcas un código de confirmación después de una cantidad máxima de identificaciones fallidas. El código se muestra en la imagen que deberías ver debajo. Si está impedido visualmente o por cualquier motivo no puede leer ese código, por favor contacta con la %sAdministración del sitio%s.', //no usuado
	...
	'LOGIN_ERROR_OAUTH_SERVICE_DOES_NOT_EXIST'	=> 'Has solicitado un servicio OAuth inexistente.',
	'LOGIN_ERROR_PASSWORD'	=> 'Has especificado una contraseña incorrecta. Por favor, verifica tu contraseña e inténtalo de nuevo. Si continúas teniendo problemas, por favor contacta con la %sAdministración del sitio%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'	=> 'No fue posible convertir tu contraseña cuando se actualizó el software de este sitio. Por favor, %ssolicita nueva contraseña%s. Si continúas teniendo problemas, por favor contacta con la %sAdministración del sitio%s.',
	'LOGIN_ERROR_USERNAME'	=> 'Has especificado un nombre de usuario incorrecto. Por favor, verifica tu nombre de usuario e inténtalo de nuevo. Si continúas teniendo problemas, por favor contacta con la %sAdministración del sitio%s.',
	'LOGIN_FORUM'	=> 'Para ver o publicar en este foro debes introducir la contraseña.',
	'LOGIN_INFO'	=> 'Para autenticarte debes estar registrado. Registrarte te tomará solo unos pocos segundos y te permitirá un amplio acceso al sistema. La Administración del sitio puede además otorgar permisos adicionales a los usuarios registrados. Antes de identificarte asegúrete de estar familiarizado con nuestros términos de uso y políticas relacionadas. Por favor, lee las normas de los foros mientras navegas por el sitio.',
	...
	'LOGIN_REQUIRED'					=> 'Necesitas loguearte para realizar esta acción.',
	...
	'NOT_ALLOWED_MANAGE_GROUP'	=> 'No tienes permitido administrar este grupo desde el "Panel de Control de Administración (PCA)".',
	...
	'NOTIFICATION_BOOKMARK'				=> array(
 	...
 	'NOTIFICATION_GROUP_REQUEST'		=> '<strong>Solicitud de grupo</strong> de %1$s para unirte al grupo %2$s.',
 	'NOTIFICATION_GROUP_REQUEST_APPROVED'	=> '<strong>Solicitud de grupo aprobada</strong> para unirte al grupo %1$s.',
	...
	'NO_AUTH_ADMIN'	=> 'No tienes permisos administrativos y por lo tanto no se te permite acceder al Panel de Control de Administración (PCA).',
	...
	'POST_PCT_ACTIVE_OWN'	=> '%.2f%% de tus mensajes',
	...
	'REMOVE'	=> 'Eliminar',
	'REMOVE_INSTALL'	=> 'Por favor borra, mueve o renombra la carpeta /install/ antes de usar tu foro. Si este directorio aún está presente solo será accesible el Panel de Control de Administración (PCA).',
	'REPLIES'	=> 'Respuestas',
	...
	'RULES_DELETE_CANNOT'	=> '<strong>No puedes</strong> borrar sus mensajes en este Foro',
	...
	'RULES_EDIT_CANNOT'	=> '<strong>No puedes</strong> editar sus mensajes en este Foro',
	'RULES_LOCK_CAN'	=> '<strong>Puedes</strong> bloquear sus temas en este Foro',
	'RULES_LOCK_CANNOT'	=> '<strong>No puedes</strong> bloquear sus temas en este Foro',
	...
	'SORRY_AUTH_READ_TOPIC'		=> 'No estás autorizado a leer este tema.',
	...
	'TOO_LONG'		=> 'El valor que has introducido es demasiado largo.',

	'TOO_LONG_CONFIRM_CODE'			=> 'El código de confirmación que has introducido es muy largo.',
	'TOO_LONG_DATEFORMAT'			=> 'El formato de fecha que has introducido es demasiado largo.',
	'TOO_LONG_JABBER'				=> 'La cuenta Jabber que has introducido es muy larga.',
	'TOO_LONG_NEW_PASSWORD'			=> 'La nueva contraseña que has introducido es muy larga.',
	'TOO_LONG_PASSWORD_CONFIRM'		=> 'La confirmación de contraseña que has introducido es muy larga.',
	'TOO_LONG_USER_PASSWORD'		=> 'La contraseña que has introducido es muy larga.',
	'TOO_LONG_USERNAME'				=> 'El nombre de usuario que has introducido es muy largo.',
	'TOO_LONG_EMAIL'				=> 'La dirección de email que has introducido es muy larga.',

	'TOO_MANY_VOTE_OPTIONS'			=> 'Ha tratado de votar demasiadas opciones.',

	'TOO_SHORT'						=> 'El valor que has introducido es demasiado corto.',

	'TOO_SHORT_CONFIRM_CODE'		=> 'El Código de confirmación que has introducido es muy corto.',
	'TOO_SHORT_DATEFORMAT'			=> 'El formato de fecha que has introducido es demasiado corto.',
	'TOO_SHORT_JABBER'				=> 'La cuenta Jabber que has introducido es muy corta.',
	'TOO_SHORT_NEW_PASSWORD'		=> 'La nueva contraseña que has introducido es muy corta.',
	'TOO_SHORT_PASSWORD_CONFIRM'	=> 'La confirmación de contraseña que has introducido es muy corta.',
	'TOO_SHORT_USER_PASSWORD'		=> 'La contraseña que has introducido es muy corta.',
	'TOO_SHORT_USERNAME'			=> 'El nombre de usuario que has introducido es muy corto.',
	'TOO_SHORT_EMAIL'				=> 'La dirección de email que has introducido es muy corta.',
	'TOO_SHORT_EMAIL_CONFIRM'		=> 'La dirección de email de confirmación que has introducido es muy corta.',
	...
	'TRACKED_PHP_ERROR'	=> 'Tracked PHP errores: %s',
	'TWITTER'			=> 'Twitter',

	'UNABLE_GET_IMAGE_SIZE'	=> 'No fue posible determinar las dimensiones de la imagen. Por favor, verifica que la URL que has introducido es correcta.',
	...
	'WRONG_PASSWORD'	=> 'Has introducido una contraseña incorrecta.',

	'WRONG_DATA_COLOUR'			=> 'El valor del color introducido no es válido.',
	'WRONG_DATA_JABBER'	=> 'El nombre que has introducido no es un nombre de cuenta Jabber válido.',
	'WRONG_DATA_LANG'	=> 'El idioma que has especificado no es válido.',
