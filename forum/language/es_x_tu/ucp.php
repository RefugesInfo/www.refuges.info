...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Al acceder a “%1$s” (en adelante, “nosotros”, “nos”, “nuestro”, “%1$s”, “%2$s”), usted acepta quedar legalmente vinculado por las siguientes condiciones. Si no acepta quedar legalmente vinculado por todas las condiciones siguientes, le rogamos que no acceda ni utilice “%1$s”. Podemos modificar estos términos en cualquier momento y haremos todo lo posible por informarle de dichos cambios. No obstante, es su responsabilidad revisar este documento periódicamente, ya que el uso continuado de “%1$s” tras la introducción de cambios constituye su aceptación de quedar legalmente vinculado por los términos actualizados y/o modificados.
	<br><br>
	Nuestros foros funcionan con phpBB (en adelante, “ellos”, “su”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipo de phpBB”), una solución de foro publicada bajo la «<a href="https://opensource.org/license/gpl-2-0">Licencia Pública General GNU v2</a>» (en adelante “GPL”), que puede descargarse desde <a href="https://www.phpbb.com/">www.phpbb.com</a>. El software phpBB solo facilita los debates en Internet; phpBB Limited no se hace responsable del contenido ni de la conducta permitida o prohibida en este sitio. Para obtener más información sobre phpBB, consulte: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Acuerda a no publicar ningún contenido abusivo, obsceno, soez, difamatorio, que incite al odio, amenazante, de carácter sexual o ilegal de cualquier otro modo, ya sea según la legislación de su país, la del país en el que se aloja “%1$s” o el derecho internacional. Hacerlo podría dar lugar a tu expulsión inmediata y permanente, con notificación a tu proveedor de servicios de Internet si lo consideramos necesario. Se registra la dirección IP de todas las publicaciones para facilitar el cumplimiento de estas condiciones.
    <br><br>
	Acepta que “%1$s” se reserve el derecho de eliminar, editar, mover o cerrar cualquier tema en cualquier momento, a nuestra entera discreción. Como usuario, acepta que cualquier información que introduzcas pueda ser almacenada en una base de datos. Aunque esta información no se revelará a terceros sin tu consentimiento, ni “%1$s” ni phpBB se harán responsables de ningún intento de piratería informática que pueda dar lugar a la compromisión de los datos.
	',

	'PRIVACY_POLICY'		=> 'Esta política explica detalladamente cómo “%1$s” y sus empresas afiliadas (en adelante, “nosotros”, “nos”, “nuestro”, “%1$s”, “%2$s”) y phpBB (en adelante “ellos”, “sus”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipo de phpBB”) utilizan la información recopilada durante su uso de este sitio (en adelante “su información”).    <br><br>
    Su información se recopila de dos maneras. Cuando navega por “%1$s”, el software phpBB creará varias cookies. Las cookies son pequeños archivos de texto almacenados en los archivos temporales de su navegador web. Las dos primeras cookies contienen un identificador de usuario (en adelante, “user-id”) y un identificador de sesión anónimo (en adelante, “session-id”), ambos asignados automáticamente por el software phpBB. Se creará una tercera cookie una vez que haya navegado por los temas dentro de “%1$s”. Esta almacena información sobre los temas que ha leído, mejorando así su experiencia de usuario.
	<br><br>
	También es posible que creemos cookies ajenas al software phpBB mientras navegas por “%1$s”. Estas cookies quedan fuera del alcance de este documento, que solo se refiere a las cookies creadas por el software phpBB.
	<br><br>
	La segunda forma en que recopilamos información es a través de los datos que usted nos envía. Esto incluye, entre otros: las publicaciones realizadas como usuario anónimo (en adelante, “publicaciones anónimas”), el registro en “%1$s” (en adelante, “su cuenta”) y las publicaciones que realice tras registrarse y mientras esté conectado (en adelante, “sus publicaciones”).
	<br><br>
	Su cuenta incluirá, como mínimo: un nombre de usuario único (en adelante, “su nombre de usuario”), una contraseña personal para iniciar sesión (en adelante, “su contraseña”) y una dirección de correo electrónico válida (en adelante, “su email”). La información de su cuenta en “%1$s” está protegida por las leyes de protección de datos aplicables en el país que nos aloja. Cualquier información adicional a su nombre de usuario, contraseña y dirección de correo electrónico que se solicite durante el registro puede ser obligatoria u opcional, a discreción de “%1$s”. En todos los casos, usted puede elegir qué información de su cuenta se muestra públicamente. También puede optar por recibir o no los correos electrónicos generados automáticamente por el software phpBB.
	<br><br>
	Su contraseña se almacena como un hash unidireccional para garantizar la seguridad. No obstante, le recomendamos que no utilices la misma contraseña en varios sitios web. Su contraseña es la clave de su cuenta en “%1$s”, así que manténgala a buen recaudo. Bajo ninguna circunstancia le pedirá nadie vinculado a “%1$s”, a phpBB o a terceros su contraseña de forma legítima. Si olvida su contraseña, puede utilizar la función “Olvidé mi contraseña” que ofrece el software phpBB. Este proceso requiere que introduzca su nombre de usuario y su dirección de correo electrónico, tras lo cual el software phpBB generará una nueva contraseña para que puedas volver a acceder a su cuenta.
	',
));
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'				=> 'Gracias por registrarte, tu cuenta ha sido creada.',
