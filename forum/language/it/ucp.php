...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Accedendo a “%1$s” (di seguito “noi”, “nostro”, “%1$s”, “%2$s”), l’utente accetta di essere legalmente vincolato dai seguenti termini. Qualora non accetti di essere legalmente vincolato da tutti i seguenti termini, è pregato di non accedere o utilizzare “%1$s”. Ci riserviamo il diritto di modificare i presenti termini in qualsiasi momento e faremo tutto il possibile per informare l’utente di tali modifiche. Tuttavia, è responsabilità dell’utente rivedere regolarmente il presente documento, poiché l’utilizzo continuato di “%1$s” dopo l’introduzione delle modifiche costituisce l’accettazione dei termini aggiornati e/o modificati.
	<br><br>
	I nostri forum sono gestiti da phpBB (di seguito "loro", "il software phpBB", "www.phpbb.com", "phpBB Limited", "phpBB Teams"), una soluzione di bacheca elettronica rilasciata sotto la "<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>" (di seguito "GPL"), scaricabile da <a href="https://www.phpbb.com/">www.phpbb.com</a>. Il software phpBB facilita esclusivamente le discussioni online; phpBB Limited non è responsabile per i contenuti o i comportamenti consentiti o vietati su questo sito. Per ulteriori informazioni su phpBB, consultare: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Accetti di non pubblicare materiale offensivo, osceno, volgare, diffamatorio, odioso, minaccioso, a sfondo sessuale o comunque illegale, sia secondo le leggi del tuo paese, del paese in cui "%1$s" è ospitato, sia secondo il diritto internazionale. La violazione di tali leggi può comportare il tuo ban immediato e permanente, con notifica al tuo provider di servizi Internet qualora lo ritenessimo necessario. L’indirizzo IP di tutti i post viene registrato per facilitare l’applicazione di queste condizioni.
	<br><br>
	Accetti che "%1$s" si riservi il diritto di rimuovere, modificare, spostare o chiudere qualsiasi argomento in qualsiasi momento, a sua esclusiva discrezione. In qualità di utente, accetti che qualsiasi informazione inserita possa essere memorizzata in un database. Sebbene queste informazioni non saranno divulgate a terzi senza il tuo consenso, né "%1$s" né phpBB saranno ritenuti responsabili per eventuali tentativi di hacking che possano compromettere i dati.
	',

	'PRIVACY_POLICY'		=> 'Questa informativa spiega in dettaglio come "%1$s" e le sue società affiliate (di seguito "noi", "ci", "nostro", "%1$s", "%2$s") e phpBB (di seguito "loro", "loro", "software phpBB", "www.phpbb.com", "phpBB Limited", "phpBB Teams") utilizzano le informazioni raccolte durante la navigazione sul sito (di seguito "le tue informazioni").
	<br><br>
	Le tue informazioni vengono raccolte in due modi. Quando navighi su "%1$s", il software phpBB crea diversi cookie. I cookie sono piccoli file di testo memorizzati nei file temporanei del tuo browser. I primi due cookie contengono un identificativo utente (di seguito "user-id") e un identificativo di sessione anonimo (di seguito "session-id"), entrambi assegnati automaticamente dal software phpBB. Un terzo cookie viene creato dopo che hai visualizzato gli argomenti all’interno di "%1$s". Questo cookie memorizza le informazioni sugli argomenti che hai letto, migliorando così la tua esperienza utente.
	<br><br>
	Potremmo anche creare cookie esterni al software phpBB durante la navigazione su "%1$s". Questi non rientrano nell’ambito di questo documento, che tratta esclusivamente i cookie creati dal software phpBB.
	<br><br>
	...
	<br><br>
	Il secondo modo in cui raccogliamo informazioni è attraverso ciò che ci invii. Questo include, a titolo esemplificativo ma non esaustivo: la pubblicazione di contenuti come utente anonimo (di seguito "post anonimi"), la registrazione su "%1$s" (di seguito "il tuo account"), i post che invii dopo la registrazione e mentre sei connesso (di seguito "i tuoi post").
	<br><br>
	Il tuo account conterrà, come minimo: un nome utente univoco (di seguito "il tuo nome utente"), una password personale utilizzata per accedere (di seguito "la tua password"), un indirizzo email valido (di seguito "la tua email"). Le informazioni del tuo account su "%1$s" sono protette dalle leggi sulla protezione dei dati applicabili nel paese che ci ospita. Qualsiasi informazione richiesta durante la registrazione, oltre al nome utente, alla password e all’indirizzo email, può essere obbligatoria o facoltativa, a discrezione di "%1$s". In ogni caso, puoi scegliere quali informazioni del tuo account rendere pubbliche. Puoi anche scegliere se ricevere o meno email generate automaticamente dal software phpBB.
	<br><br>
	La tua password viene memorizzata come hash unidirezionale per garantire la sicurezza. Tuttavia, ti consigliamo di non riutilizzare la stessa password su più siti web. La tua password è la chiave per accedere al tuo account su "%1$s", quindi ti preghiamo di custodirla con cura. In nessun caso qualcuno affiliato a "%1$s", phpBB o terze parti ti chiederà legittimamente la password. Se dimentichi la password, puoi utilizzare la funzione "Ho dimenticato la password" fornita dal software phpBB. Questa procedura richiede l’inserimento del tuo nome utente e indirizzo email, dopodiché il software phpBB genererà una nuova password per consentirti di accedere nuovamente al tuo account.',
));
