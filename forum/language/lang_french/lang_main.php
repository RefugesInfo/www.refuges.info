...
$lang['Always_notify_new_topic'] = 'Reçevoir un e-mail à chaque nouveau sujet';
...
$lang['Reg_agreement'] = 'Les administrateurs et modérateurs de ce forum s\'efforceront de supprimer ou éditer tous les messages à caractère répréhensible aussi rapidement que possible. Toutefois, il leur est impossible de passer en revue tous les messages. Vous admettez donc que tous les messages postés sur ces forums expriment la vue et opinion de leurs auteurs respectifs, et non pas des administrateurs ou modérateurs (excepté les messages postés par eux-même) et par conséquent ne peuvent pas être tenus pour responsables.<br /><br />Vous consentez à ne pas poster de messages injurieux, obscènes, vulgaires, diffamatoires, menaçants, sexuels ou tout autre message qui violeraient les lois applicables. Le faire peut vous conduire à être banni immédiatement de façon permanente. L\'adresse IP et heure de chaque message est enregistrée afin d\'aider à faire respecter ces conditions. Vous êtes d\'accord sur le fait que les administrateurs et modérateurs de ce forum ont le droit de supprimer, éditer, déplacer ou verrouiller n\'importe quel sujet de discussion à tout moment. En tant qu\'utilisateur, vous êtes d\'accord sur le fait que toutes les informations que vous donnerez ci-après seront stockées dans une base de données. Cependant, ces informations ne seront divulguées à aucune tierce personne ou société sans votre accord. Les administrateurs et modérateurs ne peuvent pas être tenus pour responsables si une tentative de piratage informatique conduit à l\'accès de ces données.<br /><br />Ce forum utilise les cookies pour stocker des informations sur votre ordinateur. Ces cookies ne contiendront aucune information que vous aurez entré ci-après; ils servent uniquement à améliorer le confort d\'utilisation. L\'adresse e-mail est utilisée afin de confirmer les détails de votre enregistrement, vous envoyer un nouveau mot de passe ou pour être tenu informé de réponses au sujets que vous suivez.';

$lang['Agree_under_13'] = 'J\'accepte le règlement et j\'ai <b>moins</b> de 13 ans';
$lang['Agree_over_13'] = 'J\'accepte le règlement';
...
$lang['Confirm_code'] = 'Merci d\'écrire la clef de confirmation ici';
$lang['Confirm_code_explain'] = '';
$lang['Message_key'] = 'clef de confirmation';
