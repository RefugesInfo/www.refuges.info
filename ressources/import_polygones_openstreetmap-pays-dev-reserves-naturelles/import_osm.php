...
if (false) // mettre à true si on veut les zones protégées
{
...
if (false) // mettre à true si on veut les départements
{
...
if (false) // mettre à true si on veut les régions
{
...
if (false) // mettre à true si on veut les pays
{
...
foreach ($conditions as $id_polygone_type => $criteres_osm)
{
  ...
  if (false) //******** ICI on supprime tous ce qu'on a déjà du type indiqué
  {
