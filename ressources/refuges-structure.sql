...
DROP INDEX public.points_sommaire;
DROP INDEX public.points_poele;
...
DROP INDEX public.points_latrines;
...
DROP INDEX public.points_eau_a_proximite;
DROP INDEX public.points_date_insertion;
DROP INDEX public.points_couvertures;
DROP INDEX public.points_cheminee;
DROP INDEX public.points_bois_a_proximite;
...
DROP INDEX public.osm_tags_k;
DROP INDEX public.osm_polygon_pkey;
DROP INDEX public.osm_polygon_index;
DROP INDEX public.osm_pois_longitude;
DROP INDEX public.osm_pois_latitude;
DROP INDEX public.osm_point_pkey;
DROP INDEX public.osm_point_index;
DROP INDEX public.lien_polygone_gps_ordre;
DROP INDEX public.lien_polygone_gps_id_polygone;
DROP INDEX public.lien_polygone_gps_id_point_gps;
DROP INDEX public.commentaires_qualite_supposee;
...
ALTER TABLE ONLY public.points_gps_sans_poly DROP CONSTRAINT points_gps_sans_poly_id_point_gps_pkey;
...
ALTER TABLE ONLY public.osm_tags DROP CONSTRAINT osm_tags_id_osm_tag_pkey;
ALTER TABLE ONLY public.osm_pois_tags DROP CONSTRAINT osm_pois_tags_id_osm_poi_id_osm_tag_pkey;
ALTER TABLE ONLY public.osm_pois DROP CONSTRAINT osm_pois_id_osm_poi_pkey;
ALTER TABLE ONLY public.lien_polygone_gps DROP CONSTRAINT lien_polygone_gps_id_lien_polygone_gps_pkey;
...
DROP TABLE public.points_gps_sans_poly;
DROP SEQUENCE public.points_gps_sans_poly_id_point_gps_seq;
DROP VIEW public.points_9;
DROP VIEW public.points_7;
DROP VIEW public.points_6;
DROP VIEW public.points_3;
DROP VIEW public.points_23;
DROP VIEW public.points_10;
...
DROP CAST (public.box3d_extent AS public.geometry);
DROP CAST (public.box3d_extent AS public.box3d);
DROP CAST (public.box3d_extent AS public.box2d);
...
DROP FUNCTION public.st_minimumboundingcircle(geometry);
...
DROP FUNCTION public.st_locatebetweenelevations(geometry, double precision, double precision);
...
DROP FUNCTION public.st_length(geography, boolean);
DROP FUNCTION public.st_length(text);
DROP FUNCTION public.st_length(geography);
...
DROP FUNCTION public.st_hausdorffdistance(geometry, geometry, double precision);
...
DROP FUNCTION public.st_geometry(box3d_extent);
...
DROP FUNCTION public.st_geohash(geometry, integer);
...
DROP FUNCTION public.st_dfullywithin(geometry, geometry, double precision);
...
DROP FUNCTION public.st_box3d_extent(box3d_extent);
...
DROP FUNCTION public.st_assvg(geography, integer, integer);
DROP FUNCTION public.st_assvg(geometry, integer, integer);
DROP FUNCTION public.st_assvg(geography, integer);
DROP FUNCTION public.st_assvg(geometry, integer);
DROP FUNCTION public.st_assvg(text);
DROP FUNCTION public.st_assvg(geography);
DROP FUNCTION public.st_assvg(geometry);
DROP FUNCTION public.st_askml(integer, geography, integer);
DROP FUNCTION public.st_askml(integer, geometry, integer);
DROP FUNCTION public.st_askml(integer, geography);
DROP FUNCTION public.st_askml(geography, integer);
DROP FUNCTION public.st_askml(integer, geometry);
DROP FUNCTION public.st_askml(geometry, integer);
DROP FUNCTION public.st_askml(text);
DROP FUNCTION public.st_askml(geography);
...
DROP FUNCTION public.st_asgml(integer, geography, integer, integer);
DROP FUNCTION public.st_asgml(integer, geometry, integer, integer);
DROP FUNCTION public.st_asgml(geography, integer, integer);
DROP FUNCTION public.st_asgml(integer, geography, integer);
DROP FUNCTION public.st_asgml(geometry, integer, integer);
DROP FUNCTION public.st_asgml(integer, geometry, integer);
DROP FUNCTION public.st_asgml(integer, geography);
DROP FUNCTION public.st_asgml(geography, integer);
...
DROP FUNCTION public.st_asgml(geography);
DROP FUNCTION public.st_asgml(geometry);
DROP FUNCTION public.st_asgeojson(integer, geography, integer, integer);
DROP FUNCTION public.st_asgeojson(integer, geometry, integer, integer);
DROP FUNCTION public.st_asgeojson(geography, integer, integer);
DROP FUNCTION public.st_asgeojson(integer, geography, integer);
DROP FUNCTION public.st_asgeojson(geometry, integer, integer);
DROP FUNCTION public.st_asgeojson(integer, geometry, integer);
DROP FUNCTION public.st_asgeojson(integer, geography);
DROP FUNCTION public.st_asgeojson(geography, integer);
DROP FUNCTION public.st_asgeojson(integer, geometry);
DROP FUNCTION public.st_asgeojson(geometry, integer);
DROP FUNCTION public.st_asgeojson(text);
DROP FUNCTION public.st_asgeojson(geography);
...
DROP FUNCTION public.st_area(geography, boolean);
DROP FUNCTION public.st_area(text);
DROP FUNCTION public.st_area(geography);
...
DROP FUNCTION public.geometry_samebox(geometry, geometry);
...
DROP FUNCTION public.geometry_gist_sel(internal, oid, internal, integer);
DROP FUNCTION public.geometry_gist_joinsel(internal, oid, internal, smallint);
...
DROP FUNCTION public.geometry(box3d_extent);
...
DROP FUNCTION public.geography_typmod_type(integer);
DROP FUNCTION public.geography_typmod_srid(integer);
DROP FUNCTION public.geography_typmod_dims(integer);
...
DROP FUNCTION public.geography_gist_consistent(internal, geometry, integer);
...
DROP FUNCTION public.box3d_extent(box3d_extent);
...
DROP FUNCTION public.box2d(box3d_extent);
...
DROP FUNCTION public._st_dwithin(geometry, geometry, double precision);
...
DROP FUNCTION public._st_dfullywithin(geometry, geometry, double precision);
...
DROP FUNCTION public._st_askml(integer, geography, integer);
DROP FUNCTION public._st_askml(integer, geometry, integer);
DROP FUNCTION public._st_asgml(integer, geography, integer, integer);
DROP FUNCTION public._st_asgml(integer, geometry, integer, integer);
...
DROP FUNCTION public.box3d_extent_out(box3d_extent);
...
CREATE FUNCTION postgis_scripts_build_date() RETURNS text
    ...
    AS $$SELECT '2011-11-21 16:14:52'::text AS version$$;
...
--
-- Name: geometry_columns; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--
...
ALTER TABLE public.geometry_columns OWNER TO refuges;
...
--
-- Name: lien_polygone_gps; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--

CREATE TABLE lien_polygone_gps (
    id_lien_polygone_gps integer DEFAULT nextval('lien_polygone_gps_id_lien_polygone_gps_seq'::regclass) NOT NULL,
    id_point_gps integer DEFAULT 0 NOT NULL,
    id_polygone integer DEFAULT 0 NOT NULL,
    ordre integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.lien_polygone_gps OWNER TO refuges;

--
-- Name: osm_point; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--
...
ALTER TABLE public.osm_point OWNER TO refuges;

--
-- Name: osm_pois; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--

CREATE TABLE osm_pois (
    id_osm_poi bigint DEFAULT 0 NOT NULL,
    longitude real DEFAULT 0 NOT NULL,
    latitude real DEFAULT 0 NOT NULL
);


ALTER TABLE public.osm_pois OWNER TO refuges;

--
-- Name: osm_pois_tags; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--

CREATE TABLE osm_pois_tags (
    id_osm_poi bigint DEFAULT 0 NOT NULL,
    id_osm_tag bigint DEFAULT 0 NOT NULL
);


ALTER TABLE public.osm_pois_tags OWNER TO refuges;

--
-- Name: osm_polygon; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--
...
ALTER TABLE public.osm_polygon OWNER TO refuges;
...
--
-- Name: osm_tags; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--

CREATE TABLE osm_tags (
    id_osm_tag integer DEFAULT nextval('osm_tags_id_osm_tag_seq'::regclass) NOT NULL,
    k character varying(255) NOT NULL,
    v character varying(255) NOT NULL
);


ALTER TABLE public.osm_tags OWNER TO refuges;
...
ALTER TABLE public.phpbb_auth_access OWNER TO refuges;
...
ALTER TABLE public.phpbb_banlist_ban_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_banlist OWNER TO refuges;
...
ALTER TABLE public.phpbb_categories_cat_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_categories OWNER TO refuges;
...
ALTER TABLE public.phpbb_config OWNER TO refuges;
...
ALTER TABLE public.phpbb_confirm OWNER TO refuges;
...
ALTER TABLE public.phpbb_disallow_disallow_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_disallow OWNER TO refuges;
...
ALTER TABLE public.phpbb_forum_prune_prune_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_forum_prune OWNER TO refuges;
...
ALTER TABLE public.phpbb_forums OWNER TO refuges;
...
ALTER TABLE public.phpbb_groups_group_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_groups OWNER TO refuges;
...
ALTER TABLE public.phpbb_posts_post_id_seq OWNER TO refuges;
...
CREATE TABLE phpbb_posts (
    ...
    poster_ip character varying(8) DEFAULT ''::character varying NOT NULL,
...
ALTER TABLE public.phpbb_posts OWNER TO refuges;
...
CREATE TABLE phpbb_posts_text (
    ...
    post_subject character varying(60),
    post_text text
);


ALTER TABLE public.phpbb_posts_text OWNER TO refuges;
...
ALTER TABLE public.phpbb_privmsgs_privmsgs_id_seq OWNER TO refuges;
...
CREATE TABLE phpbb_privmsgs (
    ...
    privmsgs_ip character varying(8) DEFAULT ''::character varying NOT NULL,
...
ALTER TABLE public.phpbb_privmsgs OWNER TO refuges;
...
ALTER TABLE public.phpbb_privmsgs_text OWNER TO refuges;
...
ALTER TABLE public.phpbb_ranks_rank_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_ranks OWNER TO refuges;
...
ALTER TABLE public.phpbb_search_rebuild_rebuild_session_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_search_rebuild OWNER TO refuges;
...
ALTER TABLE public.phpbb_search_results OWNER TO refuges;
...
ALTER TABLE public.phpbb_search_wordlist_word_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_search_wordlist OWNER TO refuges;
...
ALTER TABLE public.phpbb_search_wordmatch OWNER TO refuges;
...
CREATE TABLE phpbb_sessions (
    ...
    session_time integer DEFAULT 0 NOT NULL,
    session_ip character(8) DEFAULT '0'::character(1) NOT NULL,
...
ALTER TABLE public.phpbb_sessions OWNER TO refuges;
...
ALTER TABLE public.phpbb_smilies_smilies_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_smilies OWNER TO refuges;
...
ALTER TABLE public.phpbb_themes_themes_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_themes OWNER TO refuges;
...
ALTER TABLE public.phpbb_themes_name OWNER TO refuges;
...
ALTER TABLE public.phpbb_topics_topic_id_seq OWNER TO refuges;
...
CREATE TABLE phpbb_topics (
    ...
    forum_id integer DEFAULT 0 NOT NULL,
    topic_title character(60) DEFAULT ''::character(1) NOT NULL,
...
ALTER TABLE public.phpbb_topics OWNER TO refuges;
...
ALTER TABLE public.phpbb_topics_watch OWNER TO refuges;
...
ALTER TABLE public.phpbb_user_group OWNER TO refuges;
...
ALTER TABLE public.phpbb_users OWNER TO refuges;
...
ALTER TABLE public.phpbb_vote_desc_vote_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_vote_desc OWNER TO refuges;
...
ALTER TABLE public.phpbb_vote_results OWNER TO refuges;
...
ALTER TABLE public.phpbb_vote_voters OWNER TO refuges;
...
ALTER TABLE public.phpbb_words_word_id_seq OWNER TO refuges;
...
ALTER TABLE public.phpbb_words OWNER TO refuges;
...
CREATE TABLE point_type (
    ...
    equivalent_sommaire character varying(255) NOT NULL,
    equivalent_places character varying(50) NOT NULL,
    equivalent_proprio character varying(200) NOT NULL,
    equivalent_ferme character varying(255) NOT NULL,
    ...
    equivalent_matelas character varying(255) NOT NULL,
    ...
    equivalent_clef_a_recuperer character varying(100) NOT NULL,
    nom_icone character varying(50) NOT NULL,
    nom_icone_ferme character varying(255) NOT NULL,
    nom_icone_sommaire character varying(255) NOT NULL,
...
CREATE TABLE points (
    ...
    remark text,
    proprio text,
    ferme character varying(255),
    sommaire character varying(255),
    cheminee character varying(255),
    poele character varying(255),
    matelas character varying(255),
    places_matelas integer DEFAULT 0 NOT NULL,
    couvertures character varying(255),
    latrines character varying(255),
    bois_a_proximite character varying(255),
    eau_a_proximite character varying(255),
    clef_a_recuperer character varying(100) DEFAULT 'non'::character varying,
    date_insertion bigint DEFAULT 0 NOT NULL,
...
ALTER TABLE public.points_gps_id_point_gps_seq OWNER TO refuges;
...
ALTER TABLE public.points_gps OWNER TO refuges;

--
-- Name: points_10; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW points_10 AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE ((((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) AND (points.id_point_type = 10));


ALTER TABLE public.points_10 OWNER TO refuges;

--
-- Name: points_23; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW points_23 AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE ((((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) AND (points.id_point_type = 23));


ALTER TABLE public.points_23 OWNER TO refuges;

--
-- Name: points_3; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW points_3 AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE ((((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) AND (points.id_point_type = 3));


ALTER TABLE public.points_3 OWNER TO refuges;

--
-- Name: points_6; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW points_6 AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE ((((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) AND (points.id_point_type = 6));


ALTER TABLE public.points_6 OWNER TO refuges;

--
-- Name: points_7; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW points_7 AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE ((((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) AND (points.id_point_type = 7));


ALTER TABLE public.points_7 OWNER TO refuges;

--
-- Name: points_9; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW points_9 AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE ((((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) AND (points.id_point_type = 9));


ALTER TABLE public.points_9 OWNER TO refuges;
...
ALTER TABLE public.points_gps_sans_poly_id_point_gps_seq OWNER TO refuges;

--
-- Name: points_gps_sans_poly; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--

CREATE TABLE points_gps_sans_poly (
    id_point_gps integer DEFAULT nextval('points_gps_sans_poly_id_point_gps_seq'::regclass) NOT NULL,
...
ALTER TABLE public.points_gps_sans_poly OWNER TO refuges;
...
CREATE VIEW polys_1 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 1));


ALTER TABLE public.polys_1 OWNER TO refuges;
...
CREATE VIEW polys_10 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 10));


ALTER TABLE public.polys_10 OWNER TO refuges;
...
CREATE VIEW polys_11 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 11));


ALTER TABLE public.polys_11 OWNER TO refuges;
...
CREATE VIEW polys_12 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 12));


ALTER TABLE public.polys_12 OWNER TO refuges;
...
CREATE VIEW polys_13 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 13));


ALTER TABLE public.polys_13 OWNER TO refuges;
...
CREATE VIEW polys_3 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 3));


ALTER TABLE public.polys_3 OWNER TO refuges;
...
CREATE VIEW polys_6 AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE ((polygones.geom IS NOT NULL) AND (polygones.id_polygone_type = 6));


ALTER TABLE public.polys_6 OWNER TO refuges;

--
-- Name: spatial_ref_sys; Type: TABLE; Schema: public; Owner: refuges; Tablespace: 
--
...
ALTER TABLE public.spatial_ref_sys OWNER TO refuges;
...
--
-- Name: wfs_points; Type: VIEW; Schema: public; Owner: refuges
--

CREATE VIEW wfs_points AS
    SELECT points.id_point, points.id_point_type, points.nom, points_gps.altitude, point_type.article_demonstratif, point_type.article_defini, point_type.nom_type, point_type.nom_icone, point_type.importance, points_gps.geom FROM ((points NATURAL JOIN points_gps) NATURAL JOIN point_type) WHERE (((point_type.pas_afficher = 0) AND (points.modele = 0)) AND (points_gps.geom IS NOT NULL)) ORDER BY point_type.importance;


ALTER TABLE public.wfs_points OWNER TO refuges;
...
CREATE VIEW wfs_polys AS
    SELECT polygones.id_polygone, polygones.id_polygone_type, polygones.nom_polygone, polygones.article_partitif, polygone_type.art_dem_poly, polygone_type.art_def_poly, polygone_type.type_polygone, polygone_type.ordre_taille AS importance, to_char((random() * (1000000)::double precision), 'FM#000000'::text) AS couleur, polygones.geom FROM (polygones NATURAL JOIN polygone_type) WHERE (polygones.geom IS NOT NULL) ORDER BY polygone_type.ordre_taille;
...
--
-- Name: geometry_columns_pk; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--
...
--
-- Name: lien_polygone_gps_id_lien_polygone_gps_pkey; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--

ALTER TABLE ONLY lien_polygone_gps
    ADD CONSTRAINT lien_polygone_gps_id_lien_polygone_gps_pkey PRIMARY KEY (id_lien_polygone_gps);


--
-- Name: osm_pois_id_osm_poi_pkey; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--

ALTER TABLE ONLY osm_pois
    ADD CONSTRAINT osm_pois_id_osm_poi_pkey PRIMARY KEY (id_osm_poi);


--
-- Name: osm_pois_tags_id_osm_poi_id_osm_tag_pkey; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--

ALTER TABLE ONLY osm_pois_tags
    ADD CONSTRAINT osm_pois_tags_id_osm_poi_id_osm_tag_pkey PRIMARY KEY (id_osm_poi, id_osm_tag);


--
-- Name: osm_tags_id_osm_tag_pkey; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--

ALTER TABLE ONLY osm_tags
    ADD CONSTRAINT osm_tags_id_osm_tag_pkey PRIMARY KEY (id_osm_tag);
...
--
-- Name: points_gps_sans_poly_id_point_gps_pkey; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--

ALTER TABLE ONLY points_gps_sans_poly
    ADD CONSTRAINT points_gps_sans_poly_id_point_gps_pkey PRIMARY KEY (id_point_gps);
...
--
-- Name: spatial_ref_sys_pkey; Type: CONSTRAINT; Schema: public; Owner: refuges; Tablespace: 
--
...
CREATE INDEX commentaires_auteur ON commentaires USING btree (auteur);
...
CREATE INDEX commentaires_id_createur ON commentaires USING btree (id_createur);
...
--
-- Name: commentaires_qualite_supposee; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX commentaires_qualite_supposee ON commentaires USING btree (qualite_supposee);


--
-- Name: lien_polygone_gps_id_point_gps; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX lien_polygone_gps_id_point_gps ON lien_polygone_gps USING btree (id_point_gps);


--
-- Name: lien_polygone_gps_id_polygone; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX lien_polygone_gps_id_polygone ON lien_polygone_gps USING btree (id_polygone);


--
-- Name: lien_polygone_gps_ordre; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX lien_polygone_gps_ordre ON lien_polygone_gps USING btree (ordre);


--
-- Name: osm_point_index; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--
...
--
-- Name: osm_point_pkey; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--
...
--
-- Name: osm_pois_latitude; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX osm_pois_latitude ON osm_pois USING btree (latitude);


--
-- Name: osm_pois_longitude; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX osm_pois_longitude ON osm_pois USING btree (longitude);


--
-- Name: osm_polygon_index; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--
...
--
-- Name: osm_polygon_pkey; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX osm_polygon_pkey ON osm_polygon USING btree (osm_id);


--
-- Name: osm_tags_k; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX osm_tags_k ON osm_tags USING btree (k);
...
--
-- Name: points_bois_a_proximite; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_bois_a_proximite ON points USING btree (bois_a_proximite);


--
-- Name: points_cheminee; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_cheminee ON points USING btree (cheminee);


--
-- Name: points_couvertures; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_couvertures ON points USING btree (couvertures);


--
-- Name: points_date_insertion; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_date_insertion ON points USING btree (date_insertion);


--
-- Name: points_eau_a_proximite; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_eau_a_proximite ON points USING btree (eau_a_proximite);
...
CREATE INDEX points_ferme ON points USING btree (ferme);
...
--
-- Name: points_latrines; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_latrines ON points USING btree (latrines);
...
--
-- Name: points_poele; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_poele ON points USING btree (poele);


--
-- Name: points_sommaire; Type: INDEX; Schema: public; Owner: refuges; Tablespace: 
--

CREATE INDEX points_sommaire ON points USING btree (sommaire);
...
GRANT SELECT ON TABLE geography_columns TO refuges;


--
-- Name: osm_point; Type: ACL; Schema: public; Owner: refuges
--

REVOKE ALL ON TABLE osm_point FROM PUBLIC;
REVOKE ALL ON TABLE osm_point FROM refuges;
GRANT ALL ON TABLE osm_point TO refuges;
GRANT SELECT ON TABLE osm_point TO PUBLIC;


--
-- Name: osm_polygon; Type: ACL; Schema: public; Owner: refuges
--

REVOKE ALL ON TABLE osm_polygon FROM PUBLIC;
REVOKE ALL ON TABLE osm_polygon FROM refuges;
GRANT ALL ON TABLE osm_polygon TO refuges;
GRANT SELECT ON TABLE osm_polygon TO PUBLIC;
