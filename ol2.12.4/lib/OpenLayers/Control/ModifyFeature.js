...
OpenLayers.Control.ModifyFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: pointStyle
     * {Object} Style to be applied to the summits.
     */
/*DCM*/ pointStyle: null, // Style à appliquer aux coins

    /**
     * APIProperty: pointCursor
     * {Object} Cursor to be applied to the edit circles.
     */
/*DCM*/ pointCursor: 'move', // Curseur à appliquer aux cercles
...
/*DCM*/ this.virtualStyle.cursor = this.pointCursor; // Curseur déplacement sur tous les ronds
/*DCM*/ this.pointStyle = OpenLayers.Util.extend({}, this.virtualStyle); // Style pour les sommets
...
/*DCM*/		hoverSelect:true, // Sélection au survol de la ligne
/*DCM*/		onShiftClick: this.shiftClickFeature, // Click avec touche SHIFT enfoncée
...
/*DCM*/		onDblClick: function(feature, pixel) { // Double click sur un sommet
/*DCM*/			control.dblclick.apply(control, [feature, pixel]);
/*DCM*/		},
            featureCallbacks: {
    ...
    /**
     * Method: dblclick
     * Called when double click is performed on a feature.
     */
/*DCM*/	dblclick: function(feature, pixel) {
/*DCM*/		if (this.CLASS_NAME == 'OpenLayers.Control.ModifyFeature')
/*DCM*/			this.handleKeypress ({ // Simule une touche de suppression
/*DCM*/				keyCode: this.deleteCodes[0],
/*DCM*/				xy: pixel
/*DCM*/			});
/*DCM*/	},
...
//DCM//                 vertex = new OpenLayers.Feature.Vector(component);
/*DCM*/                 vertex = new OpenLayers.Feature.Vector(component, null, control.pointStyle); // Nouveau style des sommets
                        vertex._sketch = true;
                        vertex.renderIntent = control.vertexRenderIntent;
                        control.vertices.push(vertex);
                    } else {
