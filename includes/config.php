...
$config_wri['id_zone_accueil']=3304; // sly en fait ce sont les alpes françaises qui ne devrait servir qu'en page d'accueil pour monter cette zone par défaut sur la petite carte
