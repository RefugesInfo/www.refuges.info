...
// Nombre de résultats sortis par défaut par les formulaires de recherche
$config_wri['points_recherches']=100;

// nombre de points maximum sortis par les 2 recherches (limite de sécurité)
$config_wri['points_maximum_recherche']=2000;
...
// Signalement aux modérateurs des messages de réservation
// (On peut aussi le compléter de la config_privee type $config_wri['censure'].="|nombreux")
...
// (On peut aussi le compléter de la config_privee type $config_wri['mots_interdits'].="|merde")
...
$config_wri['api_format_detail'] = [
  'icone' => "long, lat, nom, type, id & icone",
