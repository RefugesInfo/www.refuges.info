...
OpenLayers.Lang.it = {
    ...
    // console message
    'minZoomLevelError':
        "La proprietÃ  minZoomLevel Ã¨ da utilizzare solamente " +
        "con livelli che abbiano FixedZoomLevels. Il fatto che " +
        "questo livello wfs controlli la proprietÃ  minZoomLevel Ã¨ " +
        ...
        "e sarÃ  rimossa dalla vesione 3.0. Si prega di utilizzare i " +
    ...
    'googleWarning':
        "Il livello Google non Ã¨ riuscito a caricare correttamente.<br><br>" +
        "Per evitare questo messaggio, seleziona un nuovo BaseLayer " +
        "nel selettore di livelli nell'angolo in alto a destra.<br><br>" +
        "PiÃ¹ precisamente, ciÃ² accade perchÃ¨ la libreria Google Maps " +
        "non Ã¨ stata inclusa nella pagina, oppure non contiene la " +
    ...
    'getLayerWarning':
        "Il livello ${layerType} non Ã¨ riuscito a caricare correttamente.<br><br>" +
        "Per evitare questo messaggio, seleziona un nuovo BaseLayer " +
        "nel selettore di livelli nell'angolo in alto a destra.<br><br>" +
        "PiÃ¹ precisamente, ciÃ² accade perchÃ¨ la libreria ${layerLib} " +
        "non Ã¨ stata inclusa nella pagina.<br><br>" +
        "Sviluppatori: Per aiuto su come farlo funzionare correttamente, " +
    ...
    'reprojectDeprecated':
        ...
        "Questa opzione Ã¨ deprecata: il suo utilizzo Ã¨ stato introdotto per" +
        "supportare il disegno dei dati sopra mappe commerciali, ma tale " + 
        "funzionalitÃ  dovrebbe essere ottenuta tramite l'utilizzo della proiezione " +
        "Spherical Mercator. Per maggiori informazioni consultare qui " +
        "http://trac.openlayers.org/wiki/SphericalMercator.",

    // console message
    'methodDeprecated':
        "Questo metodo Ã¨ stato deprecato e sarÃ  rimosso dalla versione 3.0. " +
